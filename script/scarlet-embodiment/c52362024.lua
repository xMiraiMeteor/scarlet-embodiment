...
function s.initial_effect(c)
    --Special Summon from hand if you control a "Scarlet" monster
	...
	c:RegisterEffect(e1)
    --Add 1 "Scarlet" Quick-Play Spell from Deck to hand
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,0x322),tp,LOCATION_MZONE,0,1,nil)
end
